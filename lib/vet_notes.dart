...
class VetNotesScreen extends StatefulWidget {
  ...
  const VetNotesScreen({super.key, required this.userData});
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.note_alt_outlined, color: primaryBlue),
          ),
            ...
            _drawerItem(
              ...
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        VetCalendarScreen(userData: widget.userData),
                  ),
                );
              },
            ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: VetAppDrawer(
        ...
        currentPage: VetDrawerPage.notes,
      ),
      body: SafeArea(
        bottom: false,
