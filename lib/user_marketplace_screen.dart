...
class UserMarketplaceScreen extends StatefulWidget {
  final Map<String, dynamic> userData;

  const UserMarketplaceScreen({super.key, required this.userData});

  @override
  State<UserMarketplaceScreen> createState() => _UserMarketplaceScreenState();
}

class _UserMarketplaceScreenState extends State<UserMarketplaceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: UserAppDrawer(userData: widget.userData, currentPage: UserDrawerPage.marketplace),
      body: SafeArea(
              ...
              children: [
                ...
                CircleAvatar(
                  ...
                  child: !avatar.startsWith('http')
                      ? Text(_fullName.isNotEmpty ? _fullName[0].toUpperCase() : 'A', style: const TextStyle(color: primaryGreen, fontWeight: FontWeight.w900))
                      : null,
                ),
              ],
            ),
                ...
                children: [
                  DecoratedBox(
                    ...
                    child: SizedBox(
                      width: 40,
                      height: 40,
                      child: Icon(Icons.eco_rounded, color: primaryGreen, size: 23),
                    ),
                  ),
                  SizedBox(width: 9),
                  Text('AgriSynth', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: deepText)),
                ],
              ),
            ),
          ],
      ...
      child: Column(
        children: List.generate(3, (index) {
          return Container(
            ...
            height: 320,
            decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(26), border: Border.all(color: _UserMarketplaceScreenState.borderColor)),
            child: Column(
              children: [
...
class _PurchaseDetailPage extends StatelessWidget {
  ...
  static const Color primaryGreen = _UserMarketplaceScreenState.primaryGreen;
  static const Color deepText = _UserMarketplaceScreenState.deepText;
  static const Color mutedText = _UserMarketplaceScreenState.mutedText;
  static const Color softBg = _UserMarketplaceScreenState.softBg;
  static const Color softGreen = _UserMarketplaceScreenState.softGreen;
  static const Color borderColor = _UserMarketplaceScreenState.borderColor;
