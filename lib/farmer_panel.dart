...
class FarmerPanel extends StatefulWidget {
  ...
  const FarmerPanel({super.key, required this.userData});
...
class _FarmerPanelState extends State<FarmerPanel>
  ...
  Future<void> _openProfileEdit() async {
    ...
    await Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => ProfileEditScreen(userData: _currentUserData)),
    );
    if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: FarmerAppDrawer(
        ...
        currentPage: FarmerDrawerPage.home,
      ),
                            ...
                            children: [
                              ...
                              _SectionHeader(
                                ...
                                onAction: () => Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => NotesScreen(userData: _currentUserData),
                                  ),
                                ),
                              ...
                              _SectionHeader(
                                ...
                                onMore: () => Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => CalendarScreen(userData: _currentUserData),
                                  ),
                                ),
                              ),
                              const SizedBox(height: 12),
                              ...
                              _SectionHeader(
                                ...
                                onMore: () => Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => MarketplaceScreen(userData: _currentUserData),
                                  ),
                                ),
                              ),
                              const SizedBox(height: 12),
