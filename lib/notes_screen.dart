...
class NotesScreen extends StatefulWidget {
  ...
  const NotesScreen({super.key, required this.userData});
        ...
        child: Column(
          children: [
            ...
            _drawerItem(
              ...
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        MarketplaceScreen(userData: widget.userData),
                  ),
                );
              },
            ),
            ...
            _drawerItem(
              ...
              onTap: () {
                Navigator.pop(context);
                _showSnackBar('Mesajlarım sayfasını sonra bağlayacağız.');
              },
            ),
            _drawerItem(
              ...
              onTap: () {
                Navigator.pop(context);
                _showSnackBar('Profil Yönetimi sayfasını sonra bağlayacağız.');
              },
            ),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: FarmerAppDrawer(
        ...
        currentPage: FarmerDrawerPage.notes,
      ),
      body: SafeArea(
        bottom: false,
