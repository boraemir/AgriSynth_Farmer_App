...
class VetProfileEditScreen extends StatefulWidget {
  final Map<String, dynamic>? userData;

  const VetProfileEditScreen({super.key, this.userData});

  @override
  State<VetProfileEditScreen> createState() => _VetProfileEditScreenState();
}

class _VetProfileEditScreenState extends State<VetProfileEditScreen> {
  ...
  void _showSnack(String message, {bool isError = false}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? const Color(0xFFE53935) : const Color(0xFF1D4ED8),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: VetAppDrawer(
        userData: _profile ?? widget.userData ?? const <String, dynamic>{},
        currentPage: VetDrawerPage.profile,
      ),
      appBar: AppBar(
        backgroundColor: const Color(0xFFFAFBFF),
        elevation: 0,
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                const Icon(Icons.workspace_premium_rounded, size: 16, color: Color(0xFF2563EB)),
