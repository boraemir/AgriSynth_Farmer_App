...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  Future<void> _updatePassword() async {
    ...
    try {
      // ÖNEMLİ:
      // "Session from session_id claim in JWT does not exist" hatası genelde
      // Supabase Auth updateUser çağrısından gelir. Bu yüzden önce senin
      // users.sifre kolonunu güncelliyoruz. Böylece Auth session bozuk olsa bile
      // veritabanındaki şifre alanı güncellenmeden işlem yarıda kalmaz.
      await _supabase
          .from('users')
      ...
      // Session bozuksa kullanıcıya tekrar giriş yaptırmak gerekir.
      try {
  ...
  Widget build(BuildContext context) {
    final drawerUserData = <String, dynamic>{
      ...?widget.userData,
      ...?_profile,
    };
    ...
    return Scaffold(
      ...
      drawer: FarmerAppDrawer(
        ...
        currentPage: FarmerDrawerPage.profile,
      ),
      appBar: AppBar(
        leading: IconButton(
